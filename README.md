...
Раздел скриншотов постепенно переводится с исторической Telegram-версии на актуальный веб-интерфейс Ортона-AI.

В актуальной версии репозитория должны демонстрироваться прежде всего:

1. главный экран Ортона-AI;
2. интерфейс руководителя;
3. управление должностями;
4. управление инструкциями;
5. интервью специалиста;
6. обучение и тестирование стажёра;
7. экран результата тестирования;
8. AI-раздел «Задать вопрос»;
9. экран авторизации.

Исторические материалы Telegram сохраняются только там, где они важны для понимания эволюции проекта.
